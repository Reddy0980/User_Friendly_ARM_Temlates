...
This Azure Resource Manager (ARM) template creates all the Azure compute resources to run JBoss EAP 7.2/EAP 7.3/EAP 7.4 setup on Red Hat Enterprise Linux (RHEL) 7.7/8.0/8.4 VM as per the user choice. The following resources are created by this template:

- RHEL 7.7/8.0/8.4 Virtual Machine
- Virtual Network
- JBoss EAP 7.2/EAP 7.3/EAP 7.4 setup on a RHEL VM
...
Build your environment with JBoss EAP 7.2/EAP 7.3/EAP 7.4 on a VM running RHEL 7.7/8.0/8.4 on Azure by clicking the **Deploy to Azure** button and fill in the following parameter values:
...
`Tags: JBoss, Red Hat, EAP 7.2, EAP 7.3, EAP 7.4, RHEL 7.7, RHEL 8.0, RHEL 8.4, Azure, Azure VM, JavaEE`
